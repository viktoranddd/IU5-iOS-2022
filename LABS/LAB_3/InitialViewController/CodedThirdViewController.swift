//
//  CodedThirdViewController.swift
//  lab3
//
...
final class CodedThirdViewController: UIViewController {
    ...
    private func setupColorControl() {
        ...
        NSLayoutConstraint.activate([
            ...
            //colorControl.bottomAnchor.constraint(equalTo: fourthLabel.topAnchor, constant: 30)
        ])
